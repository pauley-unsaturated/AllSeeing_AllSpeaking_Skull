...
#endif
#if !defined(IRIS_MAX)
  #define IRIS_MAX      820 // Iris size (0-1023) in darkest light
#endif
//Adjust these offsets and ranges if inside a mask or skull eye socket
#define eyeXOffset      -50 // aim offset on x for autonomous move, default 0
#define eyeYOffset      300  // aim offset on y, default 0
#define eyeXRange       700  // Range of motion on x, full range is 1023
